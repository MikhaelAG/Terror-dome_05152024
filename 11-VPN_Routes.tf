...
module "eu2ap_vpn_route" {
  ...
  depends_on = [module.eu2ap_vpn_tunnel, module.ap2eu_vpn_tunnel, module.vpc_networks["net1"]]
}
...
module "ap2eu_vpn_route" {
  ...
  depends_on = [module.ap2eu_vpn_tunnel, module.eu2ap_vpn_gateway, module.vpc_networks["net4"]]
}